...
if(isset($_POST['submit']))
{
	...
	$emailquery = " select * from faculty where femail='$email'";
	...
	else
	{
		if($password === $cpassword)
		{
			...
			{
			$insertquery ="insert into faculty( ffirstname, flastname, femail, fpassword) value('$firstname','$lastname','$email','$password')";
